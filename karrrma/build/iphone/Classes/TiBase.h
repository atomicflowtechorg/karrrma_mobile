...
// in simulator we redefine to format for karrrma Developer console
...
{\
	NSString * exceptionName = [@"org.karrrma." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.karrrma";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIkarrrmaNativeItemNone = -1, 
	UIkarrrmaNativeItemSpinner = -2,
	UIkarrrmaNativeItemProgressBar = -3,
	
	UIkarrrmaNativeItemSlider = -4,
	UIkarrrmaNativeItemSwitch = -5,
	UIkarrrmaNativeItemMultiButton = -6,
	UIkarrrmaNativeItemSegmented = -7,
	
	UIkarrrmaNativeItemTextView = -8,
	UIkarrrmaNativeItemTextField = -9,
	UIkarrrmaNativeItemSearchBar = -10,
	
	UIkarrrmaNativeItemPicker = -11,
	UIkarrrmaNativeItemDatePicker = -12,
	
	UIkarrrmaNativeItemInfoLight = -13,
	UIkarrrmaNativeItemInfoDark = -14,
	
	UIkarrrmaNativeItemDisclosure = -15,
	
	UIkarrrmaNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all karrrma instances of
