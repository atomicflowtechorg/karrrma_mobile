...
/**
 The base class for all karrrma modules
 */
...
/**
 karrrma Platform calls this method on startup.
 */
-(void)startup;

/**
 karrrma Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 karrrma Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 karrrma Platform calls this method on resume.
 @param sender The sender of the event.
 */
