 ...
 * Copyright (c) 2009-2011 by karrrma, Inc. All Rights Reserved.
...
//@interface karrrmaObject : NSObject
//@end

@interface karrrmaObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[karrrmaObject class]])
		{
			for (NSString *key in [[(karrrmaObject*)o modules] allKeys])
			{
